...
class RXG_SMI_Crawler {
    ...
    public function __construct($db) {
        ...
        $this->hierarchy_analyzer = new RXG_SMI_Hierarchy_Analyzer($db);
        $this->taxonomy_analyzer = new RXG_SMI_Taxonomy_Analyzer($db);
        $this->anchor_analyzer = new RXG_SMI_Anchor_Analyzer($db);
        $this->content_analyzer = new RXG_SMI_Content_Analyzer($db);
    }
